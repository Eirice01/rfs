...
// var contextPath = "/rfsWeb";  //发布时通过网关访问时这样写
...
var DEBUG = {
  ...
  // 快照批量导出ppt
  exportPPT:contextPath + '/api/leftCon/exportPPT.json',
  ...
  //人本溯源
  queryHumanisticByStaticBank: contextPath + '/api/graph/queryHumanisticByStaticBank.json',
  //默认图标
...
var RELEASE = {
  ...
  //人本溯源
  queryHumanisticByStaticBank: contextPath + '/analysis/queryHumanisticByStaticBank.do',
  //默认图标
  ...
  // 快照批量导出ppt
  exportPPT:contextPath + '/base/exportPPT.do',
  ...
  // 共同关联分析任务
  commonRelationSearch:contextPath +'/analysis/queryMutualFriend.do',
};
