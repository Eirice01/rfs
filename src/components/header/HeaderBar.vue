  ...
  <div id="header">
    ...
    <div>
      <ul class="headerRouter">
        <Dropdown v-if="addable && !isCloseCase" trigger="click">
        ...
        <!--添加下拉-->
        <Dropdown  placement="bottom-start" v-if="addable && !isCloseCase" trigger="click">
          <li class="f-csp dropDown-li" >
        ...
        <!-- @mouseenter.native="showSnapshotContent($event)" @mouseleave.native="hiddenSnapshot"
            @click="isShowSnapshot ? showSnapshotContent($event) : hiddenSnapshot"
        -->
        <Dropdown>
          <div >
            <li class="f-csp dropDown-li">
              <div class="cls-icn"><span class="iconfont icon-kuaizhao" style="font-size:20px" @click="getShowSnapshotState"></span></div>
    ...
    <div class="headerRightMenu">
      <li>
        <a>
          <Icon class="f-csp" type="ios-help-circle" size="20" id="modelIntroduction" title="模型介绍"></Icon>
        </a>
      </li>

      <li>
        <a style="display: inline-block;width: 160px;height: 56px;">
          <span class="f-csp" style="float: left;;height: 56px;">模型使用情况统计</span> <span id="sparklineBar" class="sparklineBar" style="float: left;width: 60px;height: 56px;"></span>
        </a>
      </li>
      ...
      <li class="settingList">
        <Dropdown>
          <li class="f-csp dropDown-li">
            <a>
              <Icon class="f-csp" type="md-settings" size="20" title="设置"></Icon>
            </a>
          </li>
          <DropdownMenu slot="list">
      ...
      <li style="margin: 0 15px;">
        <a @click="setTheme('a')" v-if="theme=='b'">
          <Icon class="f-csp" type="ios-shirt" size="20" title="换肤"></Icon>
        </a>
        <a @click="setTheme('b')"  v-if="theme=='a'">
          <Icon class="f-csp" type="ios-shirt" size="20" title="换肤"></Icon>
        </a>
      </li>

      <li style="margin: 0 15px;">
        <a @click="aboutProduct">
          <Icon class="f-csp" type="logo-codepen" size="20" title="关于产品"></Icon>
        </a>
      </li>
      ...
      <li style="margin: 0 15px;">
        ...
        <a @click="openWord">
          <Icon class="f-csp" type="ios-document" size="20" title="操作文档"></Icon>
        </a>
      ...
      <li class="user-info-li">
        <Dropdown>
            <li class="f-csp dropDown-li">
              <a>
                <Icon class="f-csp" type="md-person" id="userManager" size="20" ></Icon>
              </a>
            </li>
            <DropdownMenu slot="list">
    ...
    export default {
        ...
        methods: {
         //快照列表显示
          ...
          //操作文档
          openWord(){
            window.open("../../../static/operationDocument.html",)
          },
            ...
            this.$http.request({
              ...
              success: (data) => {
                if (data.code === 200){
                  ...
                  this.$store.commit("loginUser",this.userData.fullname)
                }
              }
            });
          },
