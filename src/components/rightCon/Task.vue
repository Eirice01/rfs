    ...
    /*  changeTime(time){
      ...
      initTaskInfo() {
       ...
       this.taskModel = currentGraphModel.taskModel;
        this.taskModel.createtime= DateUtil.formatDateBysdf(this.taskModel.createtime,"yyyy-MM-dd hh:mm:ss")//DateUtil.formatDate(this.taskModel.createtime);//this.changeTime(this.taskModel.createtime)
      },
