  ...
  <div id="index">
    ...
    <Layout class="main">
      ...
      <Sider hide-trigger collapsible :width="330" :collapsed-width="20" v-model="rightCollapsed" class="left-slider">
          ...
          <right-con ref="rightCon" :isActive="rightCollapsed" @showSocialExponent="showSocialExponent" @getModelInfo="getModelInfo" @setSingleLvl="setSingleLvl" @getHandSetLabel="getHandSetLabel" @getSetLableClose="getSetLableClose" @getModelTars="getModelTars"></right-con>
      </Sider>
    </Layout>
        ...
        methods: {
          ...
          getModelTars(){
            if(this.$refs.mainGraph){
              this.$refs.mainGraph.setModelTars()
            }
          },
          //获取手动改变标签指标方法
          getHandSetLabel(){
          ...
          //获取手动改变标签关闭方法
          getSetLableClose(){
            this.$refs.mainGraph.setCloselable()
          },
          //获取标签列表数据
